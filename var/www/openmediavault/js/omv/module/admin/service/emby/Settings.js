        ...
        return [{
            ...
            items : [{
                ...
                html    : 'Notes: After enabling the server you have to go through a first time setup wizard.  Skip the section where it offers to setup media shares.  Once setup is complete this can easily be done via' +
                          ...
                          ' the of end of the file and edit the <b>DenyIFrameEmbedding</b> setting so it says <b>false</b>.  Then save and exit.  <b>** Warning **</b> <b>Do not</b> use the <b>Shutdown button</b> in the Manage Server section.  You can use the Restart button throughout the Emby UI.' + 
                          '</p>' +
                          '<h3>OMV Firewall</h3>' +
